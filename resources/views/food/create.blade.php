                ...
                <div class="card-body">
                    <form action="{{ route('food.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('nutritions_fact') is-invalid @enderror" id="nutritions_fact" name="nutritions_fact" rows="3" required>{{ old('nutritions_fact') }}</textarea>
