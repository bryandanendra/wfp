...
(17, '2025_03_27_081201_create_members_table', 2),
(18, '2025_03_27_082313_add_description_to_categories_table', 3);
...
ALTER TABLE `order_food`
  ADD PRIMARY KEY (`id`),
  ADD KEY `order_food_order_id_foreign` (`order_id`);
...
--
ALTER TABLE `order_food`
  ADD CONSTRAINT `order_food_order_id_foreign` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE;
COMMIT;
